...
test('load::sets the group into the module', function (t) {
  tree.load('./test/assets/plugin.js', { key: 'e', group: 'codes' })
  t.is(tree.plugins['e'].group, 'codes')
  t.end()
})

test('load::uses localname', function (t) {
  tree.load('./test/assets/local.js', { key: 'k', group: 'codes', localname: 'localname' })
...
test('load::sets the group into the module', function (t) {
  tree.load('./test/assets/plugin.js', { key: 'h', group: 'codes' })
