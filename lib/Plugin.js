...
var getProcessed = function (processing, value, settings) {
...
Plugin.prototype.setDependants = function (key) {
	var plugins = this.tree.plugins,
		groups = this.tree.groups;

	var circularError = this.dependants[ this.dependants.indexOf( this.key ) ] || false;
	if (circularError) {
