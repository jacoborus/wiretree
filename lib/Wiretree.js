 ...
 * @param  {Object} options  exposing options
 * @return {Object}          tree
 */
...
/*!
 * Get an list with all plugin names in tree.plugins
...
Wiretree.prototype.resolve = function (callback) {
	...
	var missingDependencies = findMissingDependencies( this );
	if (missingDependencies) {
		throw new Error( 'Can\'t find tree dependencies: ' + missingDependencies.join( ', '));
	}

	var count = counter( list.length, callback );
